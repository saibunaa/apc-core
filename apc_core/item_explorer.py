...
<style>:root{--ink:#24272b;--muted:#68717c;--line:#e5e1db;--cream:#eadbc8;--paper:#fffdfa;--accent:#1d6b57;--warn:#8a6100}*{box-sizing:border-box}body{margin:0;background:var(--cream);color:var(--ink);font:14px system-ui,sans-serif}.shell{max-width:1500px;margin:auto;padding:86px 28px 28px}.utility,.toolbar,.header-grid,.workspace,.filters{display:flex;gap:10px;align-items:center}.utility{position:sticky;top:0;z-index:10;padding:16px 0;min-height:74px;background:var(--cream);justify-content:space-between;color:var(--muted);font-size:12px}.main-menu-link{position:fixed;top:16px;left:16px;z-index:12;display:inline-flex;align-items:center;min-height:42px;border:1px solid var(--line);border-radius:14px;padding:0 14px;background:var(--paper);color:var(--accent);font-weight:700;box-shadow:0 2px 6px #24272b26;text-decoration:none}.main-menu-link:focus-visible{outline:3px solid var(--accent);outline-offset:3px}.workspace{align-items:start}.main{min-width:0;flex:1}.rail{width:290px}.pane{background:var(--paper);border:1px solid var(--line);border-radius:12px;padding:14px;margin:12px 0}.header-grid{display:grid;grid-template-columns:120px 1fr 1fr 160px;align-items:stretch}.order-id{font-size:20px;font-weight:800;color:var(--accent)}label{display:block;font-weight:700;margin:6px 0}#frmOrderForm input,#frmOrderForm select,#frmOrderForm textarea,#frmOrderForm button,#frmOrderFormList input,#frmOrderFormList select,#frmOrderFormList textarea,#frmOrderFormList button{font:inherit;padding:9px;border:1px solid var(--line);border-radius:7px;width:100%}#frmOrderForm button,#frmOrderFormList button{cursor:pointer;background:var(--accent);color:#fff;font-weight:700}.secondary{background:#fff!important;color:var(--accent)!important}.guarded{color:#777!important;background:#f4f2ee!important;cursor:not-allowed}.unmapped{color:var(--warn);font-size:12px}.notes{white-space:pre-wrap;min-height:48px}.shipment{color:var(--muted);padding:11px;background:#f7f4ef}.table-wrap{overflow:auto}table{width:100%;border-collapse:collapse;margin-top:8px}th,td{border-bottom:1px solid var(--line);padding:8px;text-align:left;vertical-align:top}td.qty,td.ln{text-align:right}.annotation td{font-style:italic;background:#fff8df}.annotation td.annotation-text{font-weight:700}.modal{position:fixed;inset:0;background:#0006;display:grid;place-items:center;padding:20px;z-index:5}.modal[hidden]{display:none}.dialog{width:min(1160px,100%);max-height:90vh;overflow:auto;background:var(--paper);border-radius:12px;padding:18px}.filters{flex-wrap:wrap}.filters label{min-width:160px;flex:1}.selected{background:#dcefe5}tr[tabindex]{cursor:pointer}tr[tabindex]:focus{outline:3px solid var(--accent);outline-offset:-3px}@media(max-width:800px){.workspace{flex-direction:column}.rail{width:100%}.header-grid{grid-template-columns:1fr 1fr}.shell{padding:76px 14px 14px}.utility{align-items:flex-start;flex-direction:column}.dialog{padding:12px}.modal{padding:8px}}@media(max-width:520px){.header-grid{grid-template-columns:1fr}.toolbar{align-items:stretch;flex-direction:column}}</style>
<body><main id="frmOrderForm" class="shell"><div class="utility"><a class="main-menu-link" href="../">Main menu</a><span>Order Forms · Read-only snapshot</span></div><div class="toolbar"><button id="open-order-forms" type="button">Open</button><span id="status">Template preview</span></div>
